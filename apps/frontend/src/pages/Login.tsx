              ...
              <form onSubmit={onSubmit} className="space-y-6">
                ...
                <div className="pt-2 flex flex-col gap-3">
                  ...
                  <button 
                    ...
                    disabled={loading}
                    className="w-full py-4 bg-white/5 border border-white/10 text-white font-bold rounded-xl text-xs uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-white/10 hover:border-white/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
                  >
